...
echo "COMMAND: nerdctl run -d --gpus='\"device=0\"'--shm-size=16GB --name llm -e NGC_API_KEY -v ~/.cache/nim:/opt/nim/.cache -u 0 -p 8000:8000 nvcr.io/nim/meta/llama3-8b-instruct:1.0.0"
